...
var Juego = {
    ...
    obstaculosCarretera: [
        ...
        new Obstaculo('imagenes/valla_horizontal.png', 70, 480, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 100, 480, 30, 30, 1),
        ...
        new Obstaculo('imagenes/valla_horizontal.png', 270, 420, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 290, 400, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 860, 400, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 860, 430, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 490, 450, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 400, 65, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 750, 470, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 850, 150, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 180, 290, 30, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 70, 290, 15, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 570, 260, 15, 30, 1),
        new Obstaculo('imagenes/auto_verde_derecha.png', 850, 200, 30, 15, 1),
        new Obstaculo('imagenes/auto_verde_derecha.png', 560, 490, 30, 15, 1),
    ],
    ...
    enemigos: [
        new ZombieCaminante('imagenes/zombie1.png', 800, 100, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        ...
        new ZombieCaminante('imagenes/zombie2.png', 800, 250, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        }),
        new ZombieCaminante('imagenes/zombie3.png', 750, 350, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        ...
        new ZombieCaminante('imagenes/zombie4.png', 610, 100, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        ...
        new ZombieCaminante('imagenes/zombie1.png', 800, 200, 10, 10, 1, {
            desdeX: 0,
            hastaX: 961,
            desdeY: 0,
            hastaY: 577
        ...
        new ZombieConductor('imagenes/tren_vertical.png', 678, 500, 30, 90, 5, {
            desdeX: 678,
            hastaX: 678,
            desdeY: 0,
            hastaY: 500
...
Juego.dibujar = function() {
    ...
    //linea de llegada
    Dibujante.dibujarRectangulo('yellow', 759, 530, 128, 25);
...
Juego.dibujarFondo = function() {
    ...
    if (this.terminoJuego()) {
        ...
        Juego.capturarMovimiento = function() { return null }
        Dibujante.dibujarRectangulo = function() { return null }
        Dibujante.dibujarEntidad = function() { return null }
        this.enemigos = [];
